...
public class Chassis 
{
	...
	// constants
	private static final double TURN_SPEED_SCALING_FACTOR = 0.6;	
	private static final double ACC_DEC_RATE_FACTOR = 5.0;
	private static final double ACC_DEC_TOT_TIME_IN_SECS = 1.0;
	...
	public void RunDriveMotors(double newThrottleCmdRaw, double newTurnCmdRaw)
	{
		...
		// calc turn command
		_currentArcadeDriveTurnCmd = Utilities.RoundDouble((newTurnCmdRaw * TURN_SPEED_SCALING_FACTOR), 3);
