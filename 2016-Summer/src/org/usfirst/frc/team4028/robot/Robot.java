...
import org.usfirst.frc.team4028.robot.autonRoutines.CrossDefense;
import org.usfirst.frc.team4028.robot.autonRoutines.DoNothing;
import org.usfirst.frc.team4028.robot.autonRoutines.DriveForward;
import org.usfirst.frc.team4028.robot.autonRoutines.ZeroAllAxis;
import org.usfirst.frc.team4028.robot.constants.AutonConstants;
import org.usfirst.frc.team4028.robot.subsystems.Chassis;
import org.usfirst.frc.team4028.robot.subsystems._Cupid;
...
public class Robot extends IterativeRobot 
{
	...
	private DriveForward _driveForward;
    ...
    public void robotInit() 
    {
        ...
        _roboRioCameraServer.startAutomaticCapture(RobotMap.SHOOTER_CAMERA_NAME);
    }
    ...
    public void autonomousInit() 
    {
		...
		Auton_Drive_Throttle_Percent autonThrottlePercent = _driversStation.getAutonDriveThrottlePercentRequested();
		Auton_Drive_Time_In_Secs autonDriveTimeInSecs = _driversStation.getAutonDriveTimeInSecsRequested();
    	...
    	switch(autonMode)
    	{
    		...
    		case DRIVE_FWD:
    			_driveForward = new DriveForward(_infeed, _chassis, _puma, autonThrottlePercent, autonDriveTimeInSecs, autonPumaPosition);
    			break;
    ...
    public void teleopPeriodic() 
    {
    	...
    	else if(_driversStation.getIsOnlyInfeedTiltShootBtnJustPressed() || _infeed.getIsInfeedTiltShootStillRunning())
    	{
    		// move to shooting position ONLY if infeed is currently in Acquire or Cheval position
    		if ((_infeed.getInfeedTiltTargetPosition() == Infeed.INFEED_TILT_AXIS_DEPLOYED_POSITION_IN_ROTATIONS)
